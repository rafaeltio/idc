 ...
 */
class Cidade extends \Jupiter\IdcBundle\Entity\Cidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Jupiter\\IdcBundle\\Entity\\Cidade' . "\0" . 'id', '' . "\0" . 'Jupiter\\IdcBundle\\Entity\\Cidade' . "\0" . 'nome', '' . "\0" . 'Jupiter\\IdcBundle\\Entity\\Cidade' . "\0" . 'estado');
        }
