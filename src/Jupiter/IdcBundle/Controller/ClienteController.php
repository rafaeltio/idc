...
use Jupiter\IdcBundle\Entity\Cliente;
use Jupiter\IdcBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JupiterIdcBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("JupiterIdcBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JupiterIdcBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JupiterIdcBundle:Cliente:edit.html.twig")
     */
